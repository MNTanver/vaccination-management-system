    ...
    <form action="action_handler.php" method="POST">
        <div class="row">
            <div class="col">
                ...
                <input type="text" class="form-control" id="fname" placeholder="Enter Full Name" name="full_name" style="width: 100%;" require=1>
            </div>
            <hr>
            <div class="col">
        ...
        <div class="form-group">
            ...
            <input type="radio" name="teacher_affected" id="vtype" style="margin-right:10px;" value="no">No
            <input type="radio" name="teacher_affected" id="vtype" style="margin-right:10px;" value="yes">Yes
        </div>
        <hr>
        <div class="form-group">
            <label for="affected" style="margin-right:10px;">Teacher Vaccination Dose</label>
            <input type="checkbox" name="teacher_vaccination_dose[]" id="vtype" style="margin-right:10px;" value="1st dose">1st Dose
            <input type="checkbox" name="teacher_vaccination_dose[]" id="vtype" style="margin-right:10px;" value="2nd dose">2nd Dose
            <input type="checkbox" name="teacher_vaccination_dose[]" id="vtype" style="margin-right:10px;" value="Not Vaccinated">Not Vaccinated
        </div>
        <hr>
        <div class="form-group">
        ...
        <br>
        <button type="submit" name="teacher_login_btn" class="btn btn-dark">Submit</button>
    </form>
</div>
