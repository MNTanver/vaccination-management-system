        ...
        <form  action="action_handler.php" method="POST">
            <div class="row">
                ...
                <div  class="col">
                    ...
                    <input type="text" class="form-control" id="matric" placeholder="Enter Matric No" name="matric_no" style="width: 100%;">
                </div>
                <br>
                <div class="col">
                    <label for="mobile">Mobile No</label>
                    <input type="tel" class="form-control" id="mobile" placeholder="Enter Mobile No" name="mobile_no" style="width: 100%" >
                </div>
            </div>
            <hr>
            <div class="row">
            ...
            <div class="form-group">
                ...
                <input type="radio" name="student_affected" id="vtype" style="margin-right:10px;" value="no">No
                <input type="radio" name="student_affected" id="vtype" style="margin-right:10px;" value="yes">Yes
            </div>
            <hr>
            <div class="form-group">
                <label for="affected" style="margin-right:10px;">Student Vaccination Dose</label>
                <input type="checkbox" name="student_vaccination_dose[]" id="vtype" style="margin-right:10px;" value="1st dose">1st Dose
                <input type="checkbox" name="student_vaccination_dose[]" id="vtype" style="margin-right:10px;" value="2nd dose">2nd Dose
                <input type="checkbox" name="student_vaccination_dose[]" id="vtype" style="margin-right:10px;" value="Not Vaccinated">Not Vaccinated
            </div>
            <hr>
            <div class="form-group">
            ...
            <br>
            <button type="submit" name = "stu_login_btn" class="btn btn-dark">Submit</button>
        </form>
    </div>
